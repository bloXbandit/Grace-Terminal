export default {
  ...
  auth: {
    loginToLemonAI: "Login to Grace",
    registerLemonAIAccount: "Register Grace Account",
  ...
  lemon: {
    ...
    fullPreview: {
      ...
      editorSaveSuccess: "Changes saved successfully",
      editorSaveFailed: "Failed to save changes",
      close: "Close",
