...
export const useChatStore = defineStore('chat', {
  ...
  actions: {
    ...
    async autoTitle() {
      // Only auto-generate title after 2 user messages
      if (this.updateTitle && this.userMessageCount >= 2) {
        try {
          // 更新 title
    ...
    incrementUserMessageCount() {
      ...
      console.log('User message count:', this.userMessageCount);
      // Trigger title update after 2nd message
      if (this.userMessageCount === 2) {
        this.autoTitle();
      }
    },
