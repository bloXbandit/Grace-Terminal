...
async function test() {
  ...
  const goal = "Create a Word document with a detailed essay about World War 2. Include: a title 'World War II: A Comprehensive Overview', an introduction paragraph, 3-4 body paragraphs covering major events (Pearl Harbor, D-Day, etc.), key figures (Churchill, Roosevelt, Hitler), and the war's impact on the world. Add a conclusion. Make it professional with proper formatting.";
